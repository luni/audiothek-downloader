...
def test_parse_url_episode_urn() -> None:
    assert AudiothekClient.parse_url("https://www.ardsounds.de/folge/x/urn:ard:episode:abc/") == ResourceInfo(resource_type="episode", resource_id="urn:ard:episode:abc")


def test_parse_url_collection_urn() -> None:
    assert AudiothekClient.parse_url("https://www.ardsounds.de/sammlung/x/urn:ard:page:xyz") == ResourceInfo(resource_type="collection", resource_id="urn:ard:page:xyz")


def test_parse_url_program_urn_and_numeric() -> None:
    assert AudiothekClient.parse_url("https://www.ardsounds.de/sendung/x/urn:ard:show:111") == ResourceInfo(resource_type="program", resource_id="urn:ard:show:111")
    assert AudiothekClient.parse_url("https://www.ardsounds.de/sendung/x/12345/") == ResourceInfo(resource_type="program", resource_id="12345")
